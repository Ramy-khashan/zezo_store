              ...
              children: [
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: ImageHandler(
                        cartProduct.fields!.productImage!.stringValue!,boxFit: BoxFit.fill,),
                  ),
                ),
                SizedBox(
                  width: getWidth(10),
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        TextWidget(
                          text: camilCaseMethod(
                              cartProduct.fields!.productName!.stringValue!),
                          textSize: getFont(19),
                          isBold: true,
                        ),
                        TextWidget(
                              ...
                              IconButton(
                                onPressed: () {
                                  controller.deleteItem(
                                      index: index,
                                      id: cartProduct.name!.split("/").last);
                                },
                                icon: Icon(
                                  Icons.delete,
